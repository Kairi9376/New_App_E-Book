          ...
          child: _isLoadingData
              ...
              : SingleChildScrollView(
                  child: Form(
                    key: _formKey,
                    child: Column(
                      key: const ValueKey('admin_book_dialog_column'),
                      mainAxisSize: MainAxisSize.min,
                          ...
                          children: [
                            Row(
                              children: const [
                                ...
                                SizedBox(width: 6),
                                Text('2. ໝວດໝູ່ປຶ້ມ (Categories - ເລືອກໄດ້ຫຼາຍໝວດໝູ່)', style: TextStyle(fontSize: 13, fontWeight: FontWeight.bold, color: AppColors.primary)),
                              ],
                            ),
                          ...
                          child: Column(
                            children: [
                              ...
                              SwitchListTile(
                                ...
                                subtitle: const Text('ເປີດໃຫ້ດາວໂຫຼດຟຣີທຸກຄົນ (ຫາກປິດໄວ້ เฉพาะสมาชิก VIP/Premiere ເທົັ້ນັ້ນທີ່ດາວໂຫຼດໄດ້)'),
