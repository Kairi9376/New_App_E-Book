...
router.get('/', requireAuth, requireAdmin, kycController.getAllKyc);
router.get('/user/:userId', requireAuth, requireSelfOrAdmin('userId'), kycController.getUserKyc);
router.post('/', requireAuth, kycController.submitKyc);
router.put('/:id/status', requireAuth, requireAdmin, kycController.updateKycStatus);
